...
class GenerateBiometricEnrollIdsForChildren extends Command
{
     ...
     * @var string
     */
    protected $description = 'Generate biometric enroll IDs (2-3 digits: 10-999) for teenager children (13-21) who should attend main service';
    ...
    {
        $this->info('Generating biometric enroll IDs for teenager children (13-21)...');
        
        // Only get children who should attend main service (teenagers 13-21)
        ...
        foreach ($children as $child) {
            try {
                ...
                if (!$child->shouldAttendMainService()) {
                    $skipped++;
                    $this->warn("Skipped {$child->full_name} (age: {$child->getAge()}) - not a teenager (13-21)");
                    continue;
                }
