...
@section('content')
        ...
        <div class="card border-0 shadow-sm mb-4 analytics-hero"
            ...
            <div class="card-body p-3 d-flex align-items-center justify-content-between flex-wrap gap-2">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div>
                        <h1 class="h5 mb-0 text-white fw-semibold">Analytics Dashboard</h1>
                        <p class="mb-0 small text-white-50">Comprehensive insights and trends</p>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="card border-0 shadow-sm h-100 analytics-kpi">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <div
                                                    class="text-xs font-weight-bold text-uppercase mb-1 kpi-net {{ $financialData['totals']['net_income'] >= 0 ? 'text-success' : 'text-danger' }}">
                                                    Net Income
                                                </div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            ...
                                            <div class="ms-3">
                                                <i
                                                    class="fas fa-chart-line fa-2x {{ $financialData['totals']['net_income'] >= 0 ? 'text-success' : 'text-danger' }} opacity-75"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                ...
                                                <small class="text-muted">
                                                    {{ $memberData['totals']['total'] > 0 ? round(($memberData['totals']['male'] / $memberData['totals']['total']) * 100, 1) : 0 }}%
                                                    of total
                                                </small>
                                            </div>
                                            <div class="ms-3">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                ...
                                                <small class="text-muted">
                                                    {{ $memberData['totals']['total'] > 0 ? round(($memberData['totals']['female'] / $memberData['totals']['total']) * 100, 1) : 0 }}%
                                                    of total
                                                </small>
                                            </div>
                                            <div class="ms-3">
                                                    ...
                                                    <tbody>
                                                        @foreach($attendanceData['top_attendees'] as $index => $attendee)
                                                            <tr>
                                                                ...
                                                                <td class="text-end">
                                                                    <span
                                                                        class="badge bg-primary">{{ $attendee['attendance_count'] ?? 0 }}</span>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Color palette - Unify with brand red
            const colors = {
                primary: '#940000',
                success: '#28a745',
                info: '#17a2b8',
    ...
    <style>
        ...
        /* Section headers - Unify with brand red */
        ...
        .analytics-kpi .text-muted {
            font-size: 0.75rem;
        }

        /* Force brand red on KPI accents */
        .analytics-kpi .text-primary,
        .analytics-kpi .text-success,
        .analytics-kpi .text-info,
        .analytics-kpi .text-warning,
        .analytics-kpi i[class*="text-"] {
            color: #940000 !important;
        }

        .kpi-net.text-success {
            color: #28a745 !important;
        } /* Keep green for positive net income */
        .kpi-net.text-danger {
            color: #dc3545 !important;
        } /* Keep red for negative net income */
        ...
        /* Unify border-left colors with brand red */
        .border-left-primary,
        .border-left-success,
        .border-left-info,
        .border-left-warning,
