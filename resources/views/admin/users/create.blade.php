                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="lh-sm">
                                    ...
                                    <small style="color: white !important;">Create account for a leader (must be a member
                                        first) or administrator</small>
                                </div>
                            </div>
                            <a href="{{ route('admin.users') }}" class="btn btn-light btn-sm">
                                <i class="fas fa-arrow-left"></i> <span class="d-none d-sm-inline">Back to Users</span><span
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.users.store') }}" id="userCreateForm"
                        ...
                        <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6 mb-3">
                                    <div class="card account-type-card" onclick="selectAccountType('leader')"
                                        id="leaderCard">
                                        <div class="card-body text-center">
                                            <input type="radio" name="account_type" value="leader" id="account_type_leader"
                                                checked onchange="toggleAccountType()">
                                            <i class="fas fa-user-tie fa-3x text-primary mb-3 d-block"></i>
                                            <h5>Create for Leader</h5>
                                            <p class="text-muted mb-0">Select a member who is appointed as a leader (Pastor,
                                    ...
                                    <div class="col-12 col-md-6 mb-3">
                                        <div class="card account-type-card" onclick="selectAccountType('admin')" id="adminCard">
                                            <div class="card-body text-center">
                                                ...
                                                <p class="text-muted mb-0">Create an administrator account (not tied to a
                                                    member)</p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div id="leaderSection">
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <select class="form-select @error('leader_id') is-invalid @enderror" id="leader_id"
                                    name="leader_id" onchange="loadLeaderInfo()">
                                    <option value="">-- Select a Leader --</option>
                                    @foreach($leaders as $leader)
                                        <option value="{{ $leader['id'] }}" data-member-name="{{ $leader['member_name'] }}"
                                            ...
                                            {{ $leader['member_name'] }} - {{ $leader['position_display'] }}
                                            ({{ ucfirst($leader['role']) }})
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                @if($leaders->isEmpty())
                                    <div class="alert alert-warning mt-2">
                                        ...
                                        <ol class="mb-0 mt-2">
                                            ...
                                            <li>Then, appoint them as a leader (Pastor, Secretary, or Treasurer) and make sure
                                                the leader is <strong>Active</strong></li>
                                            <li>Come back here to create their user account</li>
                                        </ol>
                                        <hr>
                                        <strong>Common reasons a leader might not appear:</strong>
                                        <ul class="mb-0 mt-2">
                                            <li><strong>The leader is marked as Inactive</strong> - Go to <a
                                                    href="{{ route('leaders.index') }}" target="_blank">Leadership
                                                    Management</a> and make sure the leader's status is "Active"</li>
                                            <li><strong>The leader already has a user account</strong> - Check the <a
                                                    href="{{ route('admin.users') }}" target="_blank">User Management</a> page
                                                to see if an account already exists</li>
                                            <li><strong>The member relationship is missing</strong> - Verify the leader is
                                                properly linked to a member in the Leadership Management page</li>
                                            <li><strong>Position mismatch</strong> - Only Pastors, Secretaries, and Treasurers
                                                (and their assistants) can have user accounts</li>
                                        </ul>
                                        <div class="mt-3">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" class="form-control @error('email') is-invalid @enderror" id="email"
                                    name="email" value="{{ old('email') }}" placeholder="Enter email address or username" required
                                    autocomplete="username">
                                <small class="form-text text-muted" id="emailHelpText">
                                    <i class="fas fa-info-circle me-1"></i>
                                    Email or Username will be used for login. This field is required.
                                </small>
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div id="adminSection" style="display: none;">
                        <div class="row">
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="admin_name"
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('email') is-invalid @enderror"
                                    id="admin_email" name="email" value="{{ old('email') }}" placeholder="Enter email or username">
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('phone_number') is-invalid @enderror"
                                        id="admin_phone_number" name="phone_number" value="{{ old('phone_number') }}"
                    ...
                    <!-- Admin Privileges Toggle (For Leaders) -->
                    <div id="adminPrivilegesSection" class="row mt-3">
                        <div class="col-12">
                            <div class="card border-info">
                                <div class="card-body">
                                    ...
                                    <small class="text-muted d-block mt-1">
                                        ...
                                        If enabled, this user will have full access to all system settings and
                                        administrative tools, regardless of their primary role.
                                    </small>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-12 d-flex flex-column flex-sm-row gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-1"></i> <span class="d-none d-sm-inline">Create User
                                    Account</span><span class="d-sm-none">Create User</span>
                            </button>
