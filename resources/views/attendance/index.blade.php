                    ...
                    <div class="card-body">
                        ...
                        <div class="card border-warning mb-4" id="biometricTestSection">
                            ...
                            <div class="card-body" id="biometricTestContent" style="display: none;">
                                <div class="alert alert-info mb-3">
                                    <i class="fas fa-info-circle"></i> <strong>Quick Test:</strong> Enter your biometric
                                    device details below to test the connection.
                                </div>

                                <form id="biometricTestForm">
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                            <label for="test_ip" class="form-label">Device IP Address <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" id="test_ip" name="ip"
                                                value="{{ config('zkteco.ip', '192.168.100.108') }}"
                                                class="form-control form-control-sm" required
                                                placeholder="e.g., 192.168.100.108">
                                        </div>
                                        <div class="col-md-3">
                                            <label for="test_port" class="form-label">Port <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" id="test_port" name="port"
                                                value="{{ config('zkteco.port', 4370) }}"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="number" id="test_password" name="password"
                                                value="{{ config('zkteco.password', 0) }}"
                                                class="form-control form-control-sm" placeholder="0 (default)">
                                        </div>
                                        <div class="col-md-2 d-flex align-items-end">
                                            <button type="button" class="btn btn-primary btn-sm w-100"
                                                onclick="testBiometricConnection()">
                                ...
                                <div class="mt-3 border-top pt-3">
                                    <h6 class="fw-bold mb-2"><i class="fas fa-user-plus"></i> Register Members to Device
                                        (Testing Mode)</h6>
                                    <div class="alert alert-info small mb-2">
                                        <i class="fas fa-info-circle"></i> <strong>Auto-Generated Enroll IDs:</strong>
                                        The system automatically generates a unique 2-3 digit enroll ID (10-999) for each
                                        member when they are registered.
                                        <br><strong>Testing Mode:</strong> Enter member name directly to register
                                        continuously.
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label for="register_member_name" class="form-label small">Enter Member
                                                Name:</label>
                                            <input type="text" id="register_member_name"
                                            ...
                                            <small class="text-muted">Type member name and press Enter or click
                                                Register</small>
                                        </div>
                                        <div class="col-md-4 d-flex align-items-end">
                                            <button type="button" class="btn btn-success btn-sm w-100"
                                                onclick="registerMemberToDevice()">
                                ...
                                <select id="service_id" name="service_id" class="form-select"
                                    ...
                                    @foreach($services as $service)
                                        ...
                                        <option value="{{ $service->id }}" {{ $serviceId == $service->id ? 'selected' : '' }}
                                            data-date="{{ $serviceDate }}" data-theme="{{ $serviceTheme }}"
                        ...
                        @if($selectedService)
                            ...
                            <div class="alert alert-info">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    @if($serviceType === 'sunday_service')
                                        <div class="btn-group" role="group">
                                            <button type="button" id="autoSyncToggle" class="btn btn-sm btn-outline-success"
                                                onclick="toggleAutoSync()" title="Enable/Disable automatic sync from device">
                                                <i class="fas fa-sync-alt"></i> <span id="autoSyncText">Enable Auto-Sync</span>
                                            </button>
                                            <button type="button" class="btn btn-sm btn-outline-primary" onclick="syncFromDevice()"
                                ...
                                <div class="row">
                                    ...
                                    <div class="{{ $serviceType === 'children_service' ? 'col-md-4' : 'col-md-3' }}">
                                        ...
                                        @else
                                            ...
                                            <small class="text-muted d-block">
                                                ({{ $attendanceRecords->count() }} members, {{ $childAttendanceRecords->count() }}
                                                children{{ $guestsCount > 0 ? ', ' . $guestsCount . ' guests' : '' }})
                                            </small>
                                        @endif
                                    </div>
                            ...
                            <form id="attendanceForm" method="POST" action="{{ route('attendance.store') }}"
                                @if(!$canRecordAttendance) onsubmit="event.preventDefault(); showTimeRestrictionError();"
                                @endif>
                                @csrf
                                ...
                                @else
                                    ...
                                    <ul class="nav nav-tabs mb-3" id="attendanceTabs" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="children-tab" data-bs-toggle="tab"
                                                data-bs-target="#children" type="button" role="tab">
                                ...
                                <div class="tab-content" id="attendanceTabsContent">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-6">
                                                        <input type="text" id="memberSearch" class="form-control"
                                                            placeholder="Search by name, envelope, or ID..."
                                                        ...
                                                        <div class="col-md-6 col-lg-4 mb-2 member-item"
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input member-checkbox" type="checkbox"
                                                                    ...
                                                                    id="member_{{ $member->id }}" {{ $attendanceRecords->has($member->id) ? 'checked' : '' }}>
                                                                <label class="form-check-label" for="member_{{ $member->id }}">
                                                                    ...
                                                                    @if($isFromDevice)
                                                                        <span class="badge bg-success ms-2"
                                                                            title="Synced from biometric device">
                                                                            <i class="fas fa-fingerprint"></i> Device
                                                                        </span>
                                                                    @endif
                                                                    <br>
                                                                    <small class="text-muted">
                                                                        Env: {{ $member->envelope_number ?? 'N/A' }} |
                                                                        ID: {{ $member->member_id }} |
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <input type="text" id="childSearch" class="form-control"
                                                        placeholder="Search by name or envelope..." onkeyup="filterChildren()">
                                                </div>
                                                <div class="col-md-6">
                                                    <select id="childGenderFilter" class="form-select"
                                            ...
                                            <div class="row" id="childrenList">
                                                @foreach($children as $child)
                                                    ...
                                                    <div class="col-md-6 col-lg-4 mb-2 child-item"
                                                        ...
                                                        data-envelope="{{ strtolower($child->envelope_number ?? '') }}"
                                                        data-parent-envelope="{{ strtolower($child->member->envelope_number ?? '') }}"
                                                        data-gender="{{ $child->gender }}" data-age-group="{{ $ageGroup }}">
                                                        <div class="form-check">
                                                            <input class="form-check-input child-checkbox" type="checkbox"
                                                                name="child_ids[]" value="{{ $child->id }}"
                                                                id="child_{{ $child->id }}" {{ $isChecked ? 'checked' : '' }}>
                                                                ...
                                                                @if($recommendedService)
                                                                    ...
                                                                    @else
                                                                        <span class="badge bg-warning mt-1">
                                                                            ...
                                                                            Should attend:
                                                                            {{ $recommendedService === 'children_service' ? 'Children Service' : 'Main Service' }}
                                                                        </span>
                                                                    @endif
                                                                @endif
                                                            </label>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control" id="children_offering_amount"
                                                        name="children_offering_amount" step="0.01" min="0" placeholder="0.00"
                                                        value="{{ $existingOfferingAmount ?? ($selectedService && isset($selectedService->offerings_amount) ? $selectedService->offerings_amount : '') }}">
                                                </div>
                                                <small class="text-muted">Enter the total offering amount collected during Sunday
                                                    School</small>
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if($serviceType === 'sunday_service')
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <small class="text-muted">Enter the number of guests/visitors who are not church
                                                    members</small>
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-12 text-center">
                                            <button type="submit" class="btn btn-primary btn-lg" id="saveAttendanceBtn"
                        ...
                        @else
                            ...
                            <div class="text-center py-5">
                                ...
                                <p class="text-muted">Choose a service from the dropdown above to begin recording attendance.
                                </p>
                                ...
                                @if($services->isEmpty())
                                    <div class="alert alert-warning mt-4" style="max-width: 600px; margin: 20px auto;">
                                        ...
                                        <p class="mt-2 mb-0 small text-muted">
                                            <strong>Tip:</strong> You can use the same service for both Main Service and Children
                                            Service attendance. The service type you select in attendance determines which children
                                            appear.
                                        </p>
                                    </div>
                                @endif
    ...
    <script>
        ...
        function filterChildren() {
            ...
            document.querySelectorAll('.child-item').forEach(item => {
                ...
                const envelope = item.dataset.envelope || '';
                const parentEnvelope = item.dataset.parentEnvelope || '';
                const gender = item.dataset.gender;

                const matchesSearch = name.includes(searchTerm) ||
                    envelope.includes(searchTerm) ||
                    parentEnvelope.includes(searchTerm);
