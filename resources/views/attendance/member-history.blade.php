                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <p class="mb-1"><strong>Env No:</strong>
                                                    {{ $member->envelope_number ?? 'N/A' }}</p>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <p class="mb-1"><strong>Member Type:</strong>
                                                    {{ ucfirst($member->member_type) }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                @foreach($attendances as $attendance)
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <small
                                                                class="text-muted">{{ $attendance->attended_at->format('g:i A') }}</small>
                                                        </td>
                                                        <td>
