                        ...
                        <div class="col-md-8">
                            <div class="card bg-light">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p class="mb-1"><strong>Date:</strong> {{ $service->service_date ?? $service->event_date }}</p>
                                            ...
                                            <p class="mb-1"><strong>Theme/Title:</strong> {{ $service->theme ?? $service->title }}</p>
                                        </div>
                                        <div class="col-md-6">
                                            @if($serviceType === 'sunday_service')
                                                <p class="mb-1"><strong>Preacher:</strong> {{ $service->preacher ?? 'N/A' }}</p>
                                                <p class="mb-1"><strong>Start Time:</strong> {{ $service->start_time ?? 'N/A' }}</p>
                                                <p class="mb-1"><strong>End Time:</strong> {{ $service->end_time ?? 'N/A' }}</p>
                                            @else
                                                <p class="mb-1"><strong>Speaker:</strong> {{ $service->speaker ?? 'N/A' }}</p>
                                                <p class="mb-1"><strong>Start Time:</strong> {{ $service->start_time ?? 'N/A' }}</p>
                                                <p class="mb-1"><strong>End Time:</strong> {{ $service->end_time ?? 'N/A' }}</p>
                                            @endif
                                        </div>
                                        ...
                                        <tbody>
                                            @foreach($attendances as $index => $attendance)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge {{ $attendance->member->gender === 'male' ? 'bg-primary' : 'bg-pink' }}">
