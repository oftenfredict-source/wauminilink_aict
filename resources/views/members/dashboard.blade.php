...
@section('styles')
    <style>
        .bg-primary,
        .bg-gradient-primary {
            background: linear-gradient(135deg, #940000 0%, #ff4d4d 100%) !important;
        }
        ...
        .dashboard-profile-img .border-primary {
            border-color: #940000 !important;
        }

        .dashboard-profile-img .text-primary {
            color: #940000 !important;
        }
                    ...
                    <div class="card-body py-2 px-3">
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                            <div class="d-flex align-items-center gap-3">
                                <div class="dashboard-profile-img">
                                    @if($member->profile_picture)
                                        <img src="{{ asset($member->profile_picture) }}" alt="Profile Picture"
                            ...
                            <div class="d-flex align-items-center gap-3 header-widgets">
                                <div
                                    class="widget d-flex align-items-center gap-2 px-3 py-2 rounded-3 bg-primary text-white">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="card border-0 shadow-sm payment-info-banner"
                    style="background: linear-gradient(135deg, #940000 0%, #ff4d4d 100%); overflow: hidden;">
                        ...
                        <div class="marquee-wrapper" style="overflow: hidden; white-space: nowrap;">
                            <div class="marquee-content"
                                ...
                                <span class="marquee-item">
                                    ...
                                    <strong>Karibu katika kanisa la Waumini Link</strong> |
                                    <i class="fas fa-mobile-alt me-1"></i> <strong>Lipa Namba Voda:</strong> <span
                                        class="highlight-number">68019088</span> - <strong>Waumini Link</strong> |
                                    <i class="fas fa-university me-1"></i> <strong>CRDB Bank:</strong> Akaunti <span
                                        class="highlight-number">0152324275400</span> - <strong>Africa Inland Church
                                        Tanzania</strong> |
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card bg-light">
                                    <div class="card-body text-center">
                                        ...
                                        <h4 class="text-primary">TZS
                                            {{ number_format($financialSummary['total_tithes'], 2) }}
                                        </h4>
                                        <small class="text-muted">This Month: TZS
                                            {{ number_format($financialSummary['monthly_tithes'], 2) }}</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 mb-3">
                                <div class="card bg-light">
                                    <div class="card-body text-center">
                                        ...
                                        <h4 class="text-success">TZS
                                            {{ number_format($financialSummary['total_offerings'], 2) }}
                                        </h4>
                                        <small class="text-muted">This Month: TZS
                                            {{ number_format($financialSummary['monthly_offerings'], 2) }}</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 mb-3">
                                <div class="card bg-light">
                                    <div class="card-body text-center">
                                        ...
                                        <h4 class="text-info">TZS
                                            {{ number_format($financialSummary['total_donations'], 2) }}
                                        </h4>
                                        <small class="text-muted">This Month: TZS
                                            {{ number_format($financialSummary['monthly_donations'], 2) }}</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 mb-3">
                                <div class="card bg-light">
                                    <div class="card-body text-center">
                                        ...
                                        <h4 class="text-warning">TZS
                                            {{ number_format($financialSummary['total_pledges'], 2) }}
                                        </h4>
                                        <small class="text-muted">Remaining: TZS
                                            {{ number_format($financialSummary['remaining_pledges'], 2) }}</small>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-gradient-primary text-white"
                        style="background: linear-gradient(135deg, #940000 0%, #ff4d4d 100%);">
                    ...
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            @foreach($announcements['announcements']->take(3) as $announcement)
                                ...
                                @endphp
                                <div
                                    class="card mb-2 border-0 shadow-sm {{ $announcement->is_pinned ? 'border-warning border-2' : '' }} {{ $isUnread ? 'border-primary border-2' : '' }}">
                                    <div class="card-body p-3">
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div class="flex-grow-1">
                                                ...
                                                <small class="text-muted">
                                                    <span
                                                        class="badge bg-{{ $announcement->type === 'urgent' ? 'danger' : ($announcement->type === 'event' ? 'success' : ($announcement->type === 'reminder' ? 'warning' : 'info')) }} me-2">
