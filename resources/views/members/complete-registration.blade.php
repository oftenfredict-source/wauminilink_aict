                    ...
                    <div id="step1">
                            ...
                            <div class="col-md-4" id="memberTypeWrapper">
                                ...
                                <div class="col-md-4">
                                    <div class="form-floating">
                                        <input type="text" class="form-control field-locked check-envelope"
                                            name="envelope_number" id="envelope_number"
                                            value="{{ old('envelope_number', $member->envelope_number) }}" readonly
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="education_level"
                                            class="form-label small fw-bold text-muted ms-1">Education
                                            Level</label>
                                        <select class="form-select select2" name="education_level" id="education_level">
                                            ...
                                            <option value="secondary" {{ old('education_level', $member->education_level) === 'secondary' ? 'selected' : '' }}>Secondary
                                            </option>
                                            ...
                                            <option value="professor" {{ old('education_level', $member->education_level) === 'professor' ? 'selected' : '' }}>Professor
                                            </option>
                        ...
                        <div id="step3" style="display:none;">
                            <div class="row g-4 mb-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="residence_region"
                                            class="form-label small fw-bold text-muted ms-1">Region
                                            (Residence)</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="residence_district" id="residence_district"
                            ...
                            <div id="maritalStatusSection" class="border rounded-3 p-4 mb-4 bg-white shadow-sm"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="marital_status"
                                                class="form-label small fw-bold text-muted ms-1">Marital
                                                Status</label>
                                            <select class="form-select select2" name="marital_status" id="marital_status">
                                                <option value=""></option>
                                                <option value="married" {{ old('marital_status', $member->marital_status) === 'married' ? 'selected' : '' }}>Married
                                                </option>
                                                <option value="divorced" {{ old('marital_status', $member->marital_status) === 'divorced' ? 'selected' : '' }}>Divorced
                                                </option>
                                                <option value="widowed" {{ old('marital_status', $member->marital_status) === 'widowed' ? 'selected' : '' }}>Widowed
                                                </option>
                                ...
                                <div id="spouseInfoFields"
                                    ...
                                    <div class="row g-4 mb-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="spouse_gender"
                                                    class="form-label small fw-bold text-muted ms-1">Spouse Gender</label>
                                                <select class="form-select select2" name="spouse_gender" id="spouse_gender">
                                                    <option value=""></option>
                                                    <option value="male" {{ old('spouse_gender', $member->spouseMember->gender ?? '') === 'male' ? 'selected' : '' }}>
                                                        Male</option>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="spouse_tribe"
                                                    class="form-label small fw-bold text-muted ms-1">Spouse Tribe</label>
                                        ...
                                        <div class="col-md-4" id="spouseOtherTribeWrapper"
                                            style="display: {{ old('spouse_tribe', $member->spouse_tribe) === 'Other' ? 'block' : 'none' }};">
                                            <div class="form-floating">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="spouse_phone_number"
                                                    class="form-label small fw-bold text-muted ms-1">Spouse Phone
                                                    Number</label>
                                                <div class="input-group">
                                                    <span class="input-group-text">+255</span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select select2" name="spouse_church_member"
                                                    ...
                                                    <option value=""></option>
                                                    <option value="yes" {{ old('spouse_church_member', $member->spouse_church_member) === 'yes' ? 'selected' : '' }}>Yes,
                                                        church
                                                        member</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group" id="spouseEnvelopeWrapper"
                                                style="display: {{ old('spouse_church_member', $member->spouse_church_member) === 'yes' ? 'block' : 'none' }};">
                                                <label for="spouse_envelope_number"
                                                    class="form-label small fw-bold text-muted ms-1">Spouse Envelope
                                                    Number</label>
                                        ...
                                        <div class="row g-3 mb-2 align-items-end child-row" data-index="{{ $childIdx }}">
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control child-fullname"
                                                    name="children[{{ $childIdx }}][full_name]" value="{{ $child->full_name }}"
                                                    required>
                                            </div>
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <select class="form-select child-gender"
                                                    ...
                                                    <option value="male" {{ $child->gender === 'male' ? 'selected' : '' }}>Male
                                                    </option>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-text child-age bg-light"
                                                        style="min-width:40px; font-size:0.7rem;">{{ $child->date_of_birth->age }}y</span>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                ...
                                                <select class="form-select child-church-member"
                                                    ...
                                                    <option value="no" {{ $child->is_church_member === 'no' ? 'selected' : '' }}>
                                                        No</option>
                                            ...
                                            <div class="col-md-2" id="childEnvelopeWrapper_{{ $childIdx }}"
                                                ...
                                                <input type="text" class="form-control child-envelope check-envelope"
                                                    ...
                                                    data-child-id="{{ $child->id }}" value="{{ $child->envelope_number }}"
                                                    maxlength="3" minlength="3" pattern="\d{3}"
                                                    title="Please enter exactly 3 digits">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="guardian_phone"
                                                class="form-label small fw-bold text-muted ms-1">Guardian Phone</label>
                                            <div class="input-group">
                                                <span class="input-group-text">+255</span>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="guardian_relationship"
                                                class="form-label small fw-bold text-muted ms-1">Relationship</label>
                                            <select class="form-select select2" name="guardian_relationship"
                                                id="guardian_relationship">
                                                <option value=""></option>
                                                @foreach(['Parent', 'Relative', 'Neighbor', 'Friend', 'Other'] as $rel)
                                                    <option value="{{ $rel }}" {{ old('guardian_relationship', $member->guardian_relationship) === $rel ? 'selected' : '' }}>
                                                        {{ $rel }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            <table class="table table-sm table-borderless">
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="sum_mem_type">—</td>
                                                </tr>
                                                <tr>
                                                    <th>Member Type</th>
                                                    <td id="sum_member_type">—</td>
                                                </tr>
                                                <tr>
                                                    <th>Profession</th>
                                                    <td id="sum_prof">—</td>
                                        ...
                                        <div class="col-md-6">
                                            <table class="table table-sm table-borderless">
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="sum_res_region">—</td>
                                                </tr>
                                                <tr>
                                                    <th>Residence District</th>
                                                    <td id="sum_res_district">—</td>
                                                </tr>
                                                <tr>
                                                    <th>Residence Ward</th>
                                                    <td id="sum_res_ward">—</td>
                                                </tr>
                                                <tr>
                                                    <th>Residence Street</th>
                                                    <td id="sum_res_street">—</td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateStep(step) {
                ...
                document.querySelectorAll('#step' + step + ' [required], #step' + step + ' [pattern], #step' + step + ' [minlength]').forEach(el => {
                ...
                row.innerHTML = `
                                    ...
                                    <div class="col-md-2">
                                     ...
                                     <div class="col-md-2" id="childEnvelopeWrapper_${idx}" style="display:none;">
                                         <label class="form-label small fw-bold text-muted">Envelope #</label>
                                         <input type="text" class="form-control child-envelope check-envelope" name="children[${idx}][envelope_number]" data-child-id="" maxlength="3" minlength="3" pattern="\\d{3}" title="Please enter exactly 3 digits">
                                         <div class="envelope-status-msg"></div>
                                     </div>
                                    <div class="col-md-1 text-end">
            ...
            function checkEnvelopeAvailability(input, statusDiv, memberId = null, childId = null) {
                ...
                fetch(url)
                    ...
                    .then(data => {
                        if (data.invalid) {
                            statusDiv.innerHTML = '<i class="fas fa-exclamation-circle me-1"></i> ' + (data.message || 'Must be 3 digits');
                            statusDiv.className = 'envelope-status-msg text-danger small mt-1 fw-bold';
            ...
            // Delegation for blur event to handle dynamic child rows too
            document.addEventListener('blur', function (e) {
                if (e.target && e.target.classList.contains('check-envelope')) {
                    const input = e.target;
                    if (input.value && !input.checkValidity()) {
                        const statusDiv = document.getElementById(input.id + '_status') || input.parentElement.querySelector('.envelope-status-msg');
                        if (statusDiv) {
                            statusDiv.innerHTML = '<i class="fas fa-exclamation-circle me-1"></i> Must be exactly 3 digits';
                            statusDiv.className = 'envelope-status-msg text-danger small mt-1 fw-bold';
                        }
                        input.classList.add('is-invalid');
                    }
