    ...
    <style>
        * {
        ...
        .identity-card {
            ...
            height: 2.125in;
            background: linear-gradient(135deg, #940000 0%, #7a0000 50%, #940000 100%);
            border-radius: 12px;
        ...
        @media print {
            * {
            ...
            .identity-card {
                ...
                background: linear-gradient(135deg, #940000 0%, #7a0000 50%, #940000 100%) !important;
...
<body>
    ...
    <div class="identity-card">
        ...
        <div class="card-header">
            <div class="church-name">Waumini Link</div>
