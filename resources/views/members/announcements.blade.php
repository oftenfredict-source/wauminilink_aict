                ...
                <div class="card-body">
                    @if(isset($announcements['announcements']) && $announcements['announcements']->count() > 0)
                        @foreach($announcements['announcements'] as $announcement)
                            ...
                            @endphp
                            <div class="card mb-3 border-0 shadow-sm {{ $announcement->is_pinned ? 'border-warning border-2' : '' }} {{ $isUnread ? 'border-primary border-2' : '' }}">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        @if($announcement->start_date)
                                            <small class="text-muted">
                                                <i class="fas fa-calendar-check me-1"></i>Starts: {{ $announcement->start_date->format('M d, Y') }}
                                            </small>
                                        @endif
                                        @if($announcement->end_date)
                                            <small class="text-muted">
                                                <i class="fas fa-calendar-times me-1"></i>Expires: {{ $announcement->end_date->format('M d, Y') }}
                                            </small>
                                        @endif
                                        <small class="text-muted">
