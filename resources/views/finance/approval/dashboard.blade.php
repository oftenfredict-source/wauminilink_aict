                                ...
                                <div class="card border-0 shadow-sm">
                                    <div class="card-header bg-white border-0 p-0">
                                        ...
                                        <ul class="nav nav-pills nav-fill bg-white px-4 pt-3 pb-2" id="pendingTabs"
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link rounded-pill me-2 mb-3 px-3 py-2"
                                                    id="annual-fees-tab" data-bs-toggle="tab" data-bs-target="#annual-fees"
                                                    type="button" role="tab">
                                                    <i class="fas fa-calendar-check me-2"></i>
                                                    <span class="fw-bold">Annual Fees</span>
                                                    <span
                                                        class="badge bg-warning text-dark ms-2 px-2 py-1">{{ $pendingAnnualFees->count() }}</span>
                                                </button>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="card-body">
                                        <div class="tab-content" id="pendingTabsContent">
                                            ...
                                            <!-- Annual Fees Tab -->
                                            <div class="tab-pane fade" id="annual-fees" role="tabpanel">
                                                @include('finance.approval.partials.annual-fees-table', ['records' => $pendingAnnualFees, 'canApprove' => $canApprove])
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        @foreach($recentApprovals as $record)
                                                            <tr class="border-bottom">
                                                                <td class="px-4 py-3">
                                                                    ...
                                                                    @elseif($record->type == 'annual_fee')
                                                                        <span class="badge bg-warning text-dark rounded-pill px-3 py-2">
                                                                            <i class="fas fa-calendar-check me-1"></i>Annual Fee
                                                                        </span>
