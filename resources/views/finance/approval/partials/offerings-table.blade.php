            ...
            <tbody>
                @foreach($records as $record)
                    <tr data-record-type="offering" data-record-id="{{ $record->id }}">
                        ...
                        <td>{{ $record->offering_date ? \Carbon\Carbon::parse($record->offering_date)->format('M d, Y') : '-' }}
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                @if(isset($canApprove) && $canApprove)
                                    <button class="btn btn-success btn-sm" onclick="approveRecord('offering', {{ $record->id }})"
                                        title="Approve">
                                        <i class="fas fa-check"></i>
                                    </button>
                                    <button class="btn btn-danger btn-sm" onclick="rejectRecord('offering', {{ $record->id }})"
                                        title="Reject">
                                        <i class="fas fa-times"></i>
                                    </button>
                                @endif
                                <button class="btn btn-info btn-sm" onclick="viewDetails('offering', {{ $record->id }})"
                                    title="View Details">
