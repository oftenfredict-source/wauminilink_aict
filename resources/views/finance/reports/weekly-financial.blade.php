...
@section('content')
                            ...
                            <table class="table table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end"><strong>{{ number_format($totalPledgePayments, 0) }}</strong>
                                        </td>
                                    ...
                                    <tr class="table-light">
                                        ...
                                        <td class="text-end"><strong
                                                style="font-size: 1.1rem;">{{ number_format($totalIncome, 0) }}</strong>
                                        </td>
                                        <td class="text-end">
                            ...
                            <table class="table table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-light">
                                        ...
                                        <td class="text-end"><strong
                                                style="font-size: 1.1rem;">{{ number_format($totalExpenses, 0) }}</strong>
                                        </td>
                                    ...
                                    @foreach($dailyData as $day)
                                        <tr>
                                            ...
                                            <td class="text-end text-success">
                                                <strong>{{ number_format($day['income'], 0) }}</strong></td>
                                            <td class="text-end text-danger">
                                                <strong>{{ number_format($day['expenses'], 0) }}</strong></td>
                                ...
                                <tbody>
                                    @foreach($topContributors as $index => $contributor)
                                        <tr>
                                            ...
                                            <td class="text-end"><strong>{{ number_format($contributor->total_giving, 0) }}</strong>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
    ...
    <style>
        @media print {
            ...
            .footer,
            .breadcrumb,
            .card-header.bg-primary:first-of-type,
            .mt-4,
            .mb-4:has(form),
            div:has(> form) {
            ...
            .report-content::before {
                content: "WEEKLY FINANCIAL REPORT";
                display: block;
                text-align: center;
                font-size: 16pt;
                font-weight: bold;
            ...
            .report-content::after {
                content: "Weekly Period: {{ $startDate->format('M d') }} - {{ $endDate->format('M d, Y') }}";
                display: block;
                text-align: center;
                font-size: 10pt;
                color: #666;
            ...
            /* Row adjustments for summary items */
            .row {
