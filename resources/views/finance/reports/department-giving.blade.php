...
@section('content')
    ...
    <div class="container-fluid px-4">
        ...
        <div class="card border-0 shadow-sm mb-3 actions-card"
            style="background: #940000 !important; color: white !important;">
            <div class="card-header border-bottom p-2 px-3 d-flex align-items-center justify-content-between actions-header"
                onclick="toggleActions()" style="background: transparent !important;">
                <div class="d-flex align-items-center gap-2">
                    <h1 class="mb-0 mt-2 text-white fw-bold" style="font-size: 1.5rem; color: #ffffff !important;"><i
                            class="fas fa-building me-2"></i>Department Giving Report</h1>
                </div>
                <div class="d-flex align-items-center gap-2">
                    <i class="fas fa-chevron-down text-white d-md-none" id="actionsToggleIcon"
            ...
            <div class="card-body p-3" id="actionsBody">
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <button type="button" class="btn btn-light btn-sm text-danger fw-bold" onclick="exportReport('excel')">
                ...
                <div class="card border-0 shadow-sm h-100" style="border-left: 4px solid #940000 !important;">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <div class="text-xs text-uppercase fw-bold text-primary mb-1">Total Offerings</div>
                                <div class="h4 mb-0 fw-bold">TZS {{ number_format($offeringTypes->sum('total_amount'), 0) }}
                                </div>
                            </div>
                            <div class="d-flex align-items-center">
                                <i class="fas fa-gift fa-2x text-primary opacity-25"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-md-6 col-12">
                <div class="card border-0 shadow-sm h-100" style="border-left: 4px solid #940000 !important;">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <div class="text-xs text-uppercase fw-bold text-primary mb-1">Total Donations</div>
                                <div class="h4 mb-0 fw-bold">TZS {{ number_format($donationTypes->sum('total_amount'), 0) }}
                                </div>
                            </div>
                            <div class="d-flex align-items-center">
                                <i class="fas fa-heart fa-2x text-primary opacity-25"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-md-6 col-12">
                <div class="card border-0 shadow-sm h-100" style="border-left: 4px solid #940000 !important;">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <div class="text-xs text-uppercase fw-bold text-primary mb-1">Total Pledged</div>
                                <div class="h4 mb-0 fw-bold">TZS {{ number_format($pledgeTypes->sum('total_pledged'), 0) }}
                                </div>
                            </div>
                            <div class="d-flex align-items-center">
                                <i class="fas fa-handshake fa-2x text-primary opacity-25"></i>
                            </div>
                        </div>
                    </div>
                </div>
