                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <div class="h4">TZS
                                                    {{ number_format($financialSummary['summary']['net_income'], 0) }}</div>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <i
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-xl col-md-6 col-12">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-header text-white" style="background-color:#7b1e1e;">
                                        <i class="fas fa-coins me-1"></i> <strong>Tithes</strong>
                                    </div>
                                    <div class="card-body text-center py-3">
                                        <h4 class="fw-bold mb-1" style="color:#7b1e1e;">TZS {{ number_format($financialSummary['tithes']['total'], 0) }}</h4>
                                        <small class="text-muted">{{ $financialSummary['tithes']['count'] }} transactions</small>
                                        @if($financialSummary['tithes']['pending'] > 0)
                                            <div class="mt-2"><span class="badge bg-warning text-dark"><i class="fas fa-clock me-1"></i>Pending: TZS {{ number_format($financialSummary['tithes']['pending'], 0) }}</span></div>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl col-md-6 col-12">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-header bg-success text-white">
                                        <i class="fas fa-gift me-1"></i> <strong>Offerings</strong>
                                    </div>
                                    <div class="card-body text-center py-3">
                                        <h4 class="fw-bold text-success mb-1">TZS {{ number_format($financialSummary['offerings']['total'], 0) }}</h4>
                                        <small class="text-muted">{{ $financialSummary['offerings']['count'] }} transactions</small>
                                        @if($financialSummary['offerings']['pending'] > 0)
                                            <div class="mt-2"><span class="badge bg-warning text-dark"><i class="fas fa-clock me-1"></i>Pending: TZS {{ number_format($financialSummary['offerings']['pending'], 0) }}</span></div>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl col-md-6 col-12">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-header bg-info text-white">
                                        <i class="fas fa-heart me-1"></i> <strong>Donations</strong>
                                    </div>
                                    <div class="card-body text-center py-3">
                                        <h4 class="fw-bold text-info mb-1">TZS {{ number_format($financialSummary['donations']['total'], 0) }}</h4>
                                        <small class="text-muted">{{ $financialSummary['donations']['count'] }} transactions</small>
                                        @if($financialSummary['donations']['pending'] > 0)
                                            <div class="mt-2"><span class="badge bg-warning text-dark"><i class="fas fa-clock me-1"></i>Pending: TZS {{ number_format($financialSummary['donations']['pending'], 0) }}</span></div>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl col-md-6 col-12">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-header bg-warning text-white">
                                        <i class="fas fa-handshake me-1"></i> <strong>Pledges</strong>
                                    </div>
                                    <div class="card-body text-center py-3">
                                        <h4 class="fw-bold text-warning mb-1">TZS {{ number_format($financialSummary['pledges']['total_paid'], 0) }}</h4>
                                        <small class="text-muted">{{ $financialSummary['pledges']['count'] }} pledges</small>
                                        <div class="mt-2 small text-muted text-start">
                                            <div><i class="fas fa-circle-dot me-1 text-warning"></i>Pledged: TZS {{ number_format($financialSummary['pledges']['total_pledged'], 0) }}</div>
                                            <div><i class="fas fa-circle-dot me-1 text-danger"></i>Outstanding: TZS {{ number_format($financialSummary['pledges']['outstanding'], 0) }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl col-md-6 col-12">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-header bg-dark text-white">
                                        <i class="fas fa-calendar-check me-1"></i> <strong>Annual Fees</strong>
                                    </div>
                                    <div class="card-body text-center py-3">
                                        <h4 class="fw-bold text-dark mb-1">TZS {{ number_format($financialSummary['annual_fees']['total'], 0) }}</h4>
                                        <small class="text-muted">{{ $financialSummary['annual_fees']['count'] }} transactions</small>
                                        @if($financialSummary['annual_fees']['pending'] > 0)
                                            <div class="mt-2"><span class="badge bg-warning text-dark"><i class="fas fa-clock me-1"></i>Pending: TZS {{ number_format($financialSummary['annual_fees']['pending'], 0) }}</span></div>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            @foreach($financialSummary['pledges']['types'] as $type)
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <span class="text-success">TZS
                                                            {{ number_format($type->total_paid, 0) }}</span>
                                                    </td>
                                                    <td class="text-end">
            ...
            <div class="row mb-4 g-3">
                    ...
                    <div class="card bg-success text-white mb-4">
                        ...
                        <div class="card-footer d-flex align-items-center justify-content-between">
                            <a class="small text-white text-decoration-none"
                                href="{{ route('reports.department-giving') }}">
                                View Report
                            </a>
                            <div class="small text-white-50">
                                <i class="fas fa-angle-right"></i>
                ...
                <div class="col-xl-3 col-md-6 col-12">
                    <div class="card bg-info text-white mb-4">
                        ...
                        <div class="card-footer d-flex align-items-center justify-content-between">
                            <a class="small text-white text-decoration-none"
                                href="{{ route('reports.budget-performance') }}">
                                View Report
                            </a>
                            <div class="small text-white-50">
                                <i class="fas fa-angle-right"></i>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <p class="small text-muted">Export reports to PDF or Excel format for sharing and archiving.
                                </p>
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="col-md-3 col-12">
                            <div class="card h-100">
                                <div class="card-body text-center">
                                    ...
                                    <a href="{{ route('reports.department-giving') }}" class="btn btn-success">View
                                        Report</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-12">
                            <div class="card h-100">
                                <div class="card-body text-center">
                                    ...
                                    <p class="card-text">Comprehensive monthly financial report with all income and
                                        expenses.</p>
                                    <a href="{{ route('reports.monthly-financial') }}" class="btn btn-primary">View
                                        Report</a>
                                </div>
                            </div>
                        </div>
