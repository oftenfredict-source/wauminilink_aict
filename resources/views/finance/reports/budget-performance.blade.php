            ...
            <div class="card-header border-bottom p-2 px-3 d-flex align-items-center justify-content-between actions-header"
                ...
                <div class="d-flex align-items-center gap-2">
                    <h1 class="mb-0 mt-2 text-white fw-bold" style="font-size: 1.5rem; color: #ffffff !important;"><i
                            class="fas fa-wallet me-2"></i>Budget
                        Performance</h1>
                </div>
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        @if(request('budget_id') || request('start_date') || request('end_date'))
                            <span class="badge bg-white text-dark rounded-pill ms-2"
                                id="activeFiltersCount">{{ (request('budget_id') ? 1 : 0) + (request('start_date') ? 1 : 0) + (request('end_date') ? 1 : 0) }}</span>
                        @endif
                    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p class="text-muted">Period: {{ $budget->start_date->format('M d, Y') }} -
