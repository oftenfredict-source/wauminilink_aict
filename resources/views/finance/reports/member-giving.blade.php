            ...
            <div class="card-header border-bottom p-2 px-3 d-flex align-items-center justify-content-between actions-header"
                ...
                <div class="d-flex align-items-center gap-2">
                    <h1 class="mb-0 mt-2 text-white fw-bold" style="font-size: 1.5rem; color: #ffffff !important;"><i
                            class="fas fa-user-chart me-2"></i>Member
                        Giving Report</h1>
                </div>
                <div class="d-flex align-items-center gap-2">
                ...
                <div class="d-flex flex-wrap gap-2">
                    @if($member)
                        <a href="{{ route('reports.member-receipt', $member->id) }}?start_date={{ request('start_date', date('Y-01-01')) }}&end_date={{ request('end_date', date('Y-12-31')) }}"
                            class="btn btn-light btn-sm text-primary fw-bold" target="_blank">
                    ...
                    <div class="card border-0 shadow-sm h-100" style="border-left: 4px solid #940000 !important;">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <div class="text-xs text-uppercase fw-bold text-primary mb-1">Total Tithes</div>
                                    <div class="h4 mb-0 fw-bold">TZS {{ number_format($totalTithes, 0) }}</div>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <div class="h4 mb-0 fw-bold">TZS {{ number_format($totalOfferings, 0) }}</div>
                                </div>
                                <div class="d-flex align-items-center">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <div class="h4 mb-0 fw-bold">TZS {{ number_format($totalDonations, 0) }}</div>
                                </div>
                                <div class="d-flex align-items-center">
