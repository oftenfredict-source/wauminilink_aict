                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <div class="fw-bold">
                                                        {{ $tithe->member ? $tithe->member->full_name : 'Unknown Member' }}</div>
                                                    <small
                                                        class="text-muted d-none d-md-inline">{{ $tithe->member ? $tithe->member->member_id : ($tithe->member_id ? 'ID: ' . $tithe->member_id : 'N/A') }}</small>
                                                    <div class="d-md-none">
            ...
            <div class="modal-content stylish-modal">
                <form action="{{ route('finance.tithes.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="tithe_member_id" class="form-label">Member <span
                                        class="text-danger">*</span></label>
                                <select class="form-select select2-member-modal @error('member_id') is-invalid @enderror"
                                    id="tithe_member_id" name="member_id" required>
                            ...
                            <div class="col-md-6">
                                <label for="tithe_date" class="form-label">Tithe Date <span
                                        class="text-danger">*</span></label>
                                <input type="date" class="form-control @error('tithe_date') is-invalid @enderror"
                                    id="tithe_date" name="tithe_date" value="{{ old('tithe_date', date('Y-m-d')) }}"
                                    required>
                                @error('tithe_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <p>{{ $tithe->member ? $tithe->member->full_name : 'Unknown Member' }}
                                    ({{ $tithe->member ? $tithe->member->member_id : ($tithe->member_id ? 'ID: ' . $tithe->member_id : 'N/A') }})
                                </p>
                            </div>
                            <div class="col-md-6">
