    ...
    @endif
                ...
                <div class="card-body p-3" id="filterBody">
                    <div class="row g-2 mb-2">
                        ...
                        <div class="col-6 col-md-3">
                            ...
                            <select class="form-select form-select-sm" id="filter_expense_category" name="expense_category">
                                <option value="">All Categories</option>
                                <optgroup label="Report Categories">
                                    <option value="pastoreti" {{ request('expense_category') == 'pastoreti' ? 'selected' : '' }}>
                                        Pastoreti</option>
                                    <option value="posho" {{ request('expense_category') == 'posho' ? 'selected' : '' }}>Posho
                                    </option>
                                    <option value="kwaya" {{ request('expense_category') == 'kwaya' ? 'selected' : '' }}>Matumizi
                                        ya Kwaya</option>
                                    <option value="vikao" {{ request('expense_category') == 'vikao' ? 'selected' : '' }}>Gharama
                                        za Vikao</option>
                                    <option value="nauli_kikazi" {{ request('expense_category') == 'nauli_kikazi' ? 'selected' : '' }}>Nauli/Safari za kikazi</option>
                                    <option value="maji" {{ request('expense_category') == 'maji' ? 'selected' : '' }}>Gharama za
                                        Maji</option>
                                    <option value="stationery" {{ request('expense_category') == 'stationery' ? 'selected' : '' }}>Gharama za Stationery</option>
                                    <option value="ulinzi" {{ request('expense_category') == 'ulinzi' ? 'selected' : '' }}>Gharama
                                        za Ulinzi</option>
                                    <option value="umeme" {{ request('expense_category') == 'umeme' ? 'selected' : '' }}>Gharama
                                        za Umeme</option>
                                    <option value="wahubiri" {{ request('expense_category') == 'wahubiri' ? 'selected' : '' }}>
                                        Nauli kwa wahubiri waalikwa</option>
                                    <option value="ushirika_mtakatifu" {{ request('expense_category') == 'ushirika_mtakatifu' ? 'selected' : '' }}>Gharama za Ushirika Mtakatifu</option>
                                    <option value="mapambo" {{ request('expense_category') == 'mapambo' ? 'selected' : '' }}>
                                        Gharama za Mapambo</option>
                                    <option value="usafi" {{ request('expense_category') == 'usafi' ? 'selected' : '' }}>Gharama
                                        za Usafi</option>
                                    <option value="matengenezo" {{ request('expense_category') == 'matengenezo' ? 'selected' : '' }}>Matengenezo madogo</option>
                                    <option value="rambirambi" {{ request('expense_category') == 'rambirambi' ? 'selected' : '' }}>Rambirambi</option>
                                    <option value="mchungaji_huduma" {{ request('expense_category') == 'mchungaji_huduma' ? 'selected' : '' }}>Huduma kwa Mchungaji</option>
                                    <option value="fungu_ada" {{ request('expense_category') == 'fungu_ada' ? 'selected' : '' }}>
                                        Fungu/Ada ya mkristo</option>
                                    <option value="ujenzi_matumizi" {{ request('expense_category') == 'ujenzi_matumizi' ? 'selected' : '' }}>Gharama za Ujenzi</option>
                                    <option value="talanta" {{ request('expense_category') == 'talanta' ? 'selected' : '' }}>
                                        Talanta</option>
                                    <option value="pasaka_matumizi" {{ request('expense_category') == 'pasaka_matumizi' ? 'selected' : '' }}>Sherehe za Pasaka</option>
                                    <option value="krisi_matumizi" {{ request('expense_category') == 'krisi_matumizi' ? 'selected' : '' }}>Sherehe za Krismasi</option>
                                    <option value="kanisa_msubiji" {{ request('expense_category') == 'kanisa_msubiji' ? 'selected' : '' }}>Kujenga kanisa msubiji</option>
                                    <option value="makao_makuu_jengo" {{ request('expense_category') == 'makao_makuu_jengo' ? 'selected' : '' }}>Ujenzi Makao Makuu</option>
                                </optgroup>
                            </select>
                        </div>
                            ...
                            <tbody>
                                @forelse($expenses as $expense)
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-info">{{ $categoryLabels[$expense->expense_category] ?? ucfirst($expense->expense_category) }}</span>
                                        </td>
                                        <td class="text-end">
                                        ...
                                        <td>
                                            ...
                                            @elseif($expense->approval_status == 'approved')
                                                @if(auth()->user()->isTreasurer() || auth()->user()->isAdmin())
                                                    <span class="badge bg-primary px-2" onclick="markPaid({{ $expense->id }})"
                                                        style="cursor: pointer;" title="Click to mark as Paid">
                                                        Approved <i class="fas fa-mouse-pointer ms-1"></i>
                                                    </span>
                                                @else
                                        ...
                                        <td class="text-end">
                                            <div class="btn-group btn-group-sm" role="group">
                                                <button type="button" class="btn btn-sm btn-outline-primary"
                                                    onclick="viewExpense(this)" data-id="{{ $expense->id }}"
                                                    data-date="{{ $expense->expense_date->format('M d, Y') }}"
                                                    data-name="{{ $expense->expense_name }}"
                                                    data-category="{{ $categoryLabels[$expense->expense_category] ?? ucfirst($expense->expense_category) }}"
                                                ...
                                                @endif
                                                @php
                                                    $expBudget = $budgets->firstWhere('id', $expense->budget_id);
                                                @endphp
                                                <button type="button" class="btn btn-sm btn-outline-warning"
                                                    onclick="editExpense(this)" data-id="{{ $expense->id }}"
                                                    ...
                                                    data-budget-total="{{ $expBudget->total_budget ?? 0 }}"
                                                    data-budget-spent="{{ $expBudget->spent_amount ?? 0 }}"
                                                    data-budget-pending="{{ $expBudget->pending_expenses_amount ?? 0 }}"
                                                    data-budget-remaining="{{ $expBudget->remaining_with_pending ?? 0 }}"
                                                    data-budget-funded="{{ ($expBudget && $expBudget->isFullyFunded()) ? '1' : '0' }}"
                                                    data-budget-funding-percent="{{ $expBudget->funding_percentage ?? 0 }}"
                                                ...
                                                <form class="d-inline"
                                                    onsubmit="return confirmDeleteExpense(event, {{ $expense->id }})" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted">All expenses must be linked to a budget.</small>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        <div class="progress" style="height: 20px;">
                                            <div class="progress-bar" id="budgetProgressBar" role="progressbar"
                                                style="width: 0%">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="text-center p-3 border rounded"
                                                        ...
                                                        <h5 class="mb-1" id="availableAmount"
                                                            style="color: #fff; font-weight: bold;">TZS 0</h5>
                                    ...
                                    <div class="card mt-3" id="insufficientFundCard" style="display: none;">
                                        <div class="card-header bg-warning text-dark">
                                            <h6 class="mb-0">
                                                <i class="fas fa-exclamation-triangle me-1"></i>Insufficient Funds - Additional
                                                Funding Required
                                            </h6>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div id="availableFundsDisplay" class="border rounded p-2 bg-light"
                                            ...
                                            <div id="manualFundingSection">
                                                <h6 class="mb-3"><i class="fas fa-hand-holding-usd me-1"></i>Select Additional
                                                    Funding Sources:</h6>
                                                ...
                                                <div class="mt-3 p-3 border rounded bg-light">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <span id="totalAllocatedAmount" class="fw-bold text-primary">TZS
                                                            0</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="alert alert-info mb-0 mt-3">
                                                ...
                                                <strong>Note:</strong> Please allocate additional funding sources to cover the
                                                shortfall amount. The total allocated amount must equal or exceed the shortfall.
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
                <div class="modal-content">
                    ...
                    <form id="editExpenseForm" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <!-- Edit Budget Information Display -->
                                    <div id="edit_budgetInfo" class="card mt-3" style="display: none;">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="text-center">
                                                        <div class="h5 text-primary" id="edit_budgetTotal">TZS 0</div>
                                                        <small class="text-muted">Total Budget</small>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="text-center">
                                                        <div class="h5 text-warning" id="edit_budgetSpent">TZS 0</div>
                                                        <small class="text-muted">Amount Spent</small>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="text-center">
                                                        <div class="h5 text-success" id="edit_budgetRemaining">TZS 0</div>
                                                        <small class="text-muted">Remaining</small>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="text-center">
                                                        <div class="h5" id="edit_budgetFundingStatus">-</div>
                                                        <small class="text-muted">Funding Status</small>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-3">
                                                <div class="progress" style="height: 20px;">
                                                    <div class="progress-bar" id="edit_budgetProgressBar" role="progressbar"
                                                        style="width: 0%">
                                                        <span id="edit_budgetProgressText">0%</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-2">
                                                <div id="edit_budgetAlert" class="alert" style="display: none;">
                                                    <i class="fas fa-exclamation-triangle me-1"></i>
                                                    <span id="edit_budgetAlertText"></span>
                                                </div>
                                            </div>

                                            <!-- Edit Fund Summary Section -->
                                            <div class="card mt-3" id="edit_fundSummaryCard" style="display: none;">
                                                <div class="card-header">
                                                    <h6 class="mb-0">
                                                        <i class="fas fa-chart-pie me-1"></i>Fund Summary
                                                    </h6>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div
                                                                class="text-center p-3 border rounded bg-success bg-opacity-10">
                                                                <h5 class="text-success mb-1" id="edit_totalIncome">TZS 0</h5>
                                                                <small class="text-muted">Total Income</small>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div
                                                                class="text-center p-3 border rounded bg-warning bg-opacity-10">
                                                                <h5 class="text-warning mb-1" id="edit_usedAmount">TZS 0</h5>
                                                                <small class="text-muted">Used Amount</small>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="text-center p-3 border rounded"
                                                                style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                                                                <h5 class="mb-1" id="edit_availableAmount"
                                                                    style="color: #fff; font-weight: bold;">TZS 0</h5>
                                                                <small style="color: rgba(255, 255, 255, 0.9);">Available
                                                                    Amount</small>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        @else
                            <input type="hidden" id="ex_status" name="status">
                        @endif
                </div>
                <div class="mb-3">
        ...
        <script>
            ...
            window.editExpense = function (button) {
                ...
                // Populate budget summary directly from button's data attributes
                var editBudgetInfoCard = document.getElementById('edit_budgetInfo');

                if (d.budgetId && editBudgetInfoCard) {
                    var bTotal = parseFloat(d.budgetTotal) || 0;
                    var bSpent = parseFloat(d.budgetSpent) || 0;
                    var bPending = parseFloat(d.budgetPending) || 0;
                    var bRemain = parseFloat(d.budgetRemaining) || 0;
                    var bFunded = d.budgetFunded === '1';
                    var bFundPct = parseFloat(d.budgetFundingPercent) || 0;
                    var bCommitted = bSpent + bPending;
                    var bUtilPct = bTotal > 0 ? (bCommitted / bTotal) * 100 : 0;

                    var elTotal = document.getElementById('edit_budgetTotal');
                    var elSpent = document.getElementById('edit_budgetSpent');
                    var elRemain = document.getElementById('edit_budgetRemaining');
                    var elFunding = document.getElementById('edit_budgetFundingStatus');
                    var elPBar = document.getElementById('edit_budgetProgressBar');
                    var elPText = document.getElementById('edit_budgetProgressText');

                    if (elTotal) elTotal.textContent = 'TZS ' + bTotal.toLocaleString();
                    if (elSpent) elSpent.textContent = 'TZS ' + bSpent.toLocaleString();

                    if (elRemain) {
                        if (bPending > 0) {
                            elRemain.innerHTML = 'TZS ' + bRemain.toLocaleString() +
                                ' <small class="text-warning">(Pending: TZS ' + bPending.toLocaleString() + ')</small>';
                        } else {
                            elRemain.textContent = 'TZS ' + bRemain.toLocaleString();
                        }
                    }

                    if (elFunding) {
                        elFunding.textContent = bFunded ? '100% Funded' : bFundPct.toFixed(1) + '% Funded';
                        elFunding.className = bFunded ? 'h5 text-success' : 'h5 text-warning';
                    }

                    if (elPBar) {
                        elPBar.style.width = bUtilPct.toFixed(1) + '%';
                        elPBar.className = bUtilPct >= 100 ? 'progress-bar bg-danger'
                            : bUtilPct >= 90 ? 'progress-bar bg-warning'
                                : 'progress-bar bg-success';
                    }
                    if (elPText) elPText.textContent = bUtilPct.toFixed(1) + '%';

                    editBudgetInfoCard.style.display = 'block';

                    // Also select the correct option in the dropdown and fire change for fund summary
                    var budgetSel = document.getElementById('ex_budget_id');
                    if (budgetSel) {
                        for (var i = 0; i < budgetSel.options.length; i++) {
                            if (budgetSel.options[i].value == d.budgetId) {
                                budgetSel.selectedIndex = i;
                                break;
                            }
                        }
                        budgetSel.dispatchEvent(new Event('change'));
                    }
                } else if (editBudgetInfoCard) {
                    editBudgetInfoCard.style.display = 'none';
                }

                new bootstrap.Modal(document.getElementById('editExpenseModal')).show();
            };

            window.confirmDeleteExpense = function (e, id) {
                e.preventDefault();
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                window.editCurrentBudget = null;
                let editCurrentBudget = window.editCurrentBudget;
                ...
                budgetSelect.addEventListener('change', function () {
                    ...
                    if (this.value && selectedOption) {
                        currentBudget = {
                            ...
                            totalCommitted: (parseFloat(selectedOption.dataset.spent) || 0) + (parseFloat(selectedOption.dataset.pending) || 0),
                        ...
                        updateBudgetDisplay();
                        if (budgetInfo) budgetInfo.style.display = 'block';
                ...
                // Edit Modal logic
                const editBudgetSelect = document.getElementById('ex_budget_id');

                if (editBudgetSelect) {
                    editBudgetSelect.addEventListener('change', function () {
                        const selectedOption = this.options[this.selectedIndex];
                        const editBudgetInfo = document.getElementById('edit_budgetInfo');
                        ...
                        if (this.value && selectedOption) {
                            ...
                            window.editCurrentBudget = editCurrentBudget;

                            updateEditBudgetDisplay();
                            if (editBudgetInfo) editBudgetInfo.style.display = 'block';

                            // Fetch and display fund summary for edit modal
                            fetchEditBudgetInfo(this.value);
                            fetchEditFundSummary(this.value);
                        } else {
                            editCurrentBudget = null;
                            window.editCurrentBudget = null;
                            if (editBudgetInfo) editBudgetInfo.style.display = 'none';
                        }
                    });
                }

                // Expose updateEditBudgetDisplay globally so editExpense() can call it
                window.triggerEditBudgetSummary = function (budgetId) {
                    const select = document.getElementById('ex_budget_id');
                    if (!select) return;
                    let found = false;
                    for (let i = 0; i < select.options.length; i++) {
                        if (select.options[i].value == budgetId) {
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                function updateEditBudgetDisplay() {
                    if (!editCurrentBudget) return;

                    const pendingExpenses = editCurrentBudget.pendingExpenses || 0;
                    const totalCommitted = editCurrentBudget.totalCommitted || (editCurrentBudget.spent + pendingExpenses);

                    const budgetTotalEl = document.getElementById('edit_budgetTotal');
                    const budgetSpentEl = document.getElementById('edit_budgetSpent');
                    const budgetRemainingEl = document.getElementById('edit_budgetRemaining');
                    const fundingStatusEl = document.getElementById('edit_budgetFundingStatus');
                    const progressBarEl = document.getElementById('edit_budgetProgressBar');
                    const progressTextEl = document.getElementById('edit_budgetProgressText');

                    if (budgetTotalEl) budgetTotalEl.textContent = 'TZS ' + editCurrentBudget.total.toLocaleString();
                    if (budgetSpentEl) budgetSpentEl.textContent = 'TZS ' + editCurrentBudget.spent.toLocaleString();

                    if (budgetRemainingEl) {
                        if (pendingExpenses > 0) {
                            budgetRemainingEl.innerHTML = `TZS ${editCurrentBudget.remaining.toLocaleString()} <small class="text-warning">(Pending: TZS ${pendingExpenses.toLocaleString()})</small>`;
                        } else {
                            budgetRemainingEl.textContent = 'TZS ' + editCurrentBudget.remaining.toLocaleString();
                        }
                    }

                    if (fundingStatusEl) {
                        if (editCurrentBudget.funded) {
                            fundingStatusEl.textContent = '100% Funded';
                            fundingStatusEl.className = 'h5 text-success';
                        } else {
                            fundingStatusEl.textContent = editCurrentBudget.fundingPercent.toFixed(1) + '% Funded';
                            fundingStatusEl.className = 'h5 text-warning';
                        }
                    }

                    if (progressBarEl && progressTextEl) {
                        const utilizationPercent = (totalCommitted / editCurrentBudget.total) * 100;
                        progressBarEl.style.width = utilizationPercent + '%';
                        progressTextEl.textContent = utilizationPercent.toFixed(1) + '%';
                ...
                function fetchEditBudgetInfo(budgetId) {
                    fetch(`/finance/budgets/${budgetId}/summary`)
                        .then(response => response.json())
                        .then(data => {
                            if (data.success && editCurrentBudget && editCurrentBudget.id == budgetId) {
                                editCurrentBudget.total = data.total_budget;
                                editCurrentBudget.spent = data.spent_amount;
                                editCurrentBudget.pendingExpenses = data.pending_expenses_amount;
                                editCurrentBudget.totalCommitted = data.total_committed;
                                editCurrentBudget.remaining = data.remaining_with_pending;
                                editCurrentBudget.funded = data.is_funded;
                                editCurrentBudget.fundingPercent = data.funding_percent;
                                updateEditBudgetDisplay();
                            }
                        });
                }

                function fetchEditFundSummary(budgetId) {
                    const fundSummaryCard = document.getElementById('edit_fundSummaryCard');
                    if (!fundSummaryCard) return;

                    fetch(`/finance/budgets/${budgetId}/fund-summary`)
                        .then(response => response.json())
                        .then(data => {
                            if (data.success && editCurrentBudget && editCurrentBudget.id == budgetId) {
                                const totalIncomeEl = document.getElementById('edit_totalIncome');
                                const usedAmountEl = document.getElementById('edit_usedAmount');
                                const availableAmountEl = document.getElementById('edit_availableAmount');

                                if (totalIncomeEl) totalIncomeEl.textContent = 'TZS ' + data.total_income.toLocaleString();
                                if (usedAmountEl) usedAmountEl.textContent = 'TZS ' + data.total_used.toLocaleString();
                                if (availableAmountEl) availableAmountEl.textContent = 'TZS ' + data.available_amount.toLocaleString();
