...
@section('content')
    ...
    <div class="container-fluid px-4">
        ...
        <div class="card border-0 shadow-sm mb-3 actions-card">
            <div class="card-header bg-white border-bottom p-2 px-3 d-flex align-items-center justify-content-between actions-header"
                ...
                <div class="d-flex align-items-center gap-2">
                    <h1 class="mb-0 mt-2" style="font-size: 1.5rem;"><i class="fas fa-gift me-2"></i>Offerings Management
                    </h1>
                </div>
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        @if(request('offering_type') || request('date_from') || request('date_to'))
                            <span class="badge bg-white text-primary rounded-pill ms-2"
                                id="activeFiltersCount">{{ (request('offering_type') ? 1 : 0) + (request('date_from') ? 1 : 0) + (request('date_to') ? 1 : 0) }}</span>
                        @endif
                    </div>
                ...
                <div class="row g-2 mb-2">
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <select class="form-select form-select-sm" id="offering_type" name="offering_type">
                            ...
                            <optgroup label="Mifuko ya Sinodi">
                                <option value="sadaka" {{ request('offering_type') == 'sadaka' ? 'selected' : '' }}>Sadaka
                                </option>
                                <option value="zaka" {{ request('offering_type') == 'zaka' ? 'selected' : '' }}>Zaka</option>
                                <option value="shukurani" {{ request('offering_type') == 'shukurani' ? 'selected' : '' }}>
                                    Shukurani</option>
                                <option value="sunday_school" {{ request('offering_type') == 'sunday_school' ? 'selected' : '' }}>Sunday School</option>
                                <option value="mavuno" {{ request('offering_type') == 'mavuno' ? 'selected' : '' }}>
                                    Mavuno/Malimbuko</option>
                                <option value="ushirika_mtakatifu" {{ request('offering_type') == 'ushirika_mtakatifu' ? 'selected' : '' }}>Ushirika Mtakatifu</option>
                            </optgroup>
                            <optgroup label="Matoleo Mengine">
                                <option value="talanta" {{ request('offering_type') == 'talanta' ? 'selected' : '' }}>Talanta
                                </option>
                                <option value="mchungaji" {{ request('offering_type') == 'mchungaji' ? 'selected' : '' }}>
                                    Huduma kwa Mchungaji</option>
                                <option value="fungu_ada" {{ request('offering_type') == 'fungu_ada' ? 'selected' : '' }}>
                                    Fungu/Ada ya mkristo</option>
                            </optgroup>
                            <optgroup label="Machangizo Mbalimbali">
                                <option value="pasaka" {{ request('offering_type') == 'pasaka' ? 'selected' : '' }}>Sherehe za
                                    Pasaka</option>
                                <option value="krisimasi" {{ request('offering_type') == 'krisimasi' ? 'selected' : '' }}>
                                    Sherehe za Krismasi</option>
                                <option value="ujenzi" {{ request('offering_type') == 'ujenzi' ? 'selected' : '' }}>Ujenzi wa
                                    Kanisa</option>
                                <option value="tank" {{ request('offering_type') == 'tank' ? 'selected' : '' }}>Ununuzi wa
                                    Tank</option>
                                <option value="makao_makuu" {{ request('offering_type') == 'makao_makuu' ? 'selected' : '' }}>
                                    Ujenzi wa Jengo la makao makuu</option>
                            </optgroup>
        ...
        <div class="card mb-4">
            <div class="card-header bg-primary text-white">
                ...
                <span class="badge bg-white text-primary ms-2 fw-bold">{{ $offerings->total() }}
                    {{ $offerings->total() == 1 ? 'record' : 'records' }}</span>
            </div>
            <div class="card-body">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <div class="fw-bold">{{ $offering->member->full_name ?? 'General Member' }}
                                                    </div>
                                                    ...
                                                    <div class="d-md-none">
                                                        <small class="text-muted d-block">
                                                            ...
                                                            <span
                                                                class="badge bg-{{ $offering->payment_method == 'cash' ? 'success' : ($offering->payment_method == 'bank_transfer' ? 'info' : 'warning') }} badge-sm">
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-{{ $offering->offering_type == 'general' ? 'primary' : ($offering->offering_type == 'special' ? 'warning' : 'info') }}">
                                        ...
                                        <td class="d-none d-lg-table-cell">
                                            <span
                                                class="badge bg-{{ $offering->payment_method == 'cash' ? 'success' : ($offering->payment_method == 'bank_transfer' ? 'info' : 'warning') }}">
                                                {{ ucfirst(str_replace('_', ' ', $offering->payment_method)) }}
                                            </span>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-end">
                                            <div class="btn-group btn-group-sm" role="group">
                                                <button type="button" class="btn btn-outline-success text-white"
                                                    data-bs-toggle="modal" data-bs-target="#viewOfferingModal{{ $offering->id }}"
                                                    title="View Details">
            ...
            <div class="modal-content stylish-modal">
                <form action="{{ route('finance.offerings.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select select2-member-modal @error('member_id') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('offering_type') is-invalid @enderror" id="offering_type"
                                    ...
                                    <optgroup label="Mifuko ya Sinodi">
                                        <option value="sadaka" {{ old('offering_type') == 'sadaka' ? 'selected' : '' }}>Sadaka
                                        </option>
                                        <option value="zaka" {{ old('offering_type') == 'zaka' ? 'selected' : '' }}>Zaka
                                        </option>
                                        <option value="shukurani" {{ old('offering_type') == 'shukurani' ? 'selected' : '' }}>
                                            Shukurani</option>
                                        <option value="sunday_school" {{ old('offering_type') == 'sunday_school' ? 'selected' : '' }}>Sunday School</option>
                                        <option value="mavuno" {{ old('offering_type') == 'mavuno' ? 'selected' : '' }}>
                                            Mavuno/Malimbuko</option>
                                        <option value="ushirika_mtakatifu" {{ old('offering_type') == 'ushirika_mtakatifu' ? 'selected' : '' }}>Ushirika Mtakatifu</option>
                                    </optgroup>
                                    <optgroup label="Matoleo Mengine">
                                        <option value="talanta" {{ old('offering_type') == 'talanta' ? 'selected' : '' }}>
                                            Talanta</option>
                                        <option value="mchungaji" {{ old('offering_type') == 'mchungaji' ? 'selected' : '' }}>
                                            Huduma kwa Mchungaji</option>
                                        <option value="fungu_ada" {{ old('offering_type') == 'fungu_ada' ? 'selected' : '' }}>
                                            Fungu/Ada ya mkristo</option>
                                    </optgroup>
                                    <optgroup label="Machangizo Mbalimbali">
                                        <option value="pasaka" {{ old('offering_type') == 'pasaka' ? 'selected' : '' }}>
                                            Sherehe za Pasaka</option>
                                        <option value="krisimasi" {{ old('offering_type') == 'krisimasi' ? 'selected' : '' }}>
                                            Sherehe za Krismasi</option>
                                        <option value="ujenzi" {{ old('offering_type') == 'ujenzi' ? 'selected' : '' }}>Ujenzi
                                            wa Kanisa</option>
                                        <option value="tank" {{ old('offering_type') == 'tank' ? 'selected' : '' }}>Ununuzi wa
                                            Tank</option>
                                        <option value="makao_makuu" {{ old('offering_type') == 'makao_makuu' ? 'selected' : '' }}>Ujenzi wa Jengo la makao makuu</option>
                                    </optgroup>
                            ...
                            <div class="col-md-6" id="custom_offering_type_group" style="display: none !important;">
                                <label for="custom_offering_type" class="form-label">Custom Offering Type <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('custom_offering_type') is-invalid @enderror"
                                    id="custom_offering_type" name="custom_offering_type"
                            ...
                            <div class="col-md-6">
                                <div class="alert alert-info mt-4">
                                    ...
                                    <strong>Note:</strong> All offerings require pastor approval before being added to
                                    totals.
                                </div>
                            </div>
                            <div class="col-12">
                    ...
                    <div class="modal-footer stylish-modal-footer">
                        ...
                        <button type="submit" class="btn btn-success stylish-submit-btn"
                            style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%); border: none; box-shadow: 0 4px 15px rgba(40, 167, 69, 0.3);">
    ...
    @foreach($offerings as $offering)
        <div class="modal fade" id="viewOfferingModal{{ $offering->id }}" tabindex="-1"
            aria-labelledby="viewOfferingModalLabel{{ $offering->id }}" aria-hidden="true">
