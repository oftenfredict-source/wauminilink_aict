                            ...
                            <div class="col-md-6 col-12">
                                ...
                                @else
                                    <div class="alert alert-danger">
                                        ...
                                        Member record missing or deleted.
                                    </div>
                                @endif
                            </div>
                            <div class="col-md-6 col-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mt-1">
                                        <span class="badge bg-{{ $leader->is_active ? 'success' : 'secondary' }} fs-6">
                                            <i
                                                class="fas fa-{{ $leader->is_active ? 'check-circle' : 'pause-circle' }} me-1"></i>
                                ...
                                @if($leader->end_date)
                                    <div class="mb-3">
                                        ...
                                        <div class="mt-1">
                                            <i
                                                class="fas fa-calendar-times me-1 text-{{ $leader->end_date < now() ? 'danger' : ($leader->end_date < now()->addDays(30) ? 'warning' : 'info') }}"></i>
                                            {{ $leader->end_date->format('F d, Y') }}
                                            @if($leader->end_date < now())
                                                <br><small class="text-danger"><i class="fas fa-exclamation-circle me-1"></i>Term
                                                    has expired</small>
                                            @elseif($leader->end_date < now()->addDays(30))
                                                <br><small class="text-warning"><i class="fas fa-exclamation-triangle me-1"></i>Term
                                                    expires soon</small>
                                            @endif
                                        </div>
                                    </div>
                        ...
                        <div class="row text-center">
                            <div class="col-6">
                                <div class="border-end">
                                    <div class="h5 mb-0">{{ $leader->member?->leadershipPositions()->count() ?? 0 }}</div>
                                    <div class="small text-muted">Total Positions</div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div>
                                    <div class="h5 mb-0">{{ $leader->member?->activeLeadershipPositions()->count() ?? 0 }}
                                    </div>
