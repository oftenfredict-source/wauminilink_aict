                        ...
                        <form method="POST" action="{{ route('leader.password.update') }}" id="changePasswordForm">
                            ...
                            <div class="mb-4">
                                <label for="new_password_confirmation" class="form-label fw-bold">
                                    <i class="fas fa-check-circle me-2"></i>Confirm New Password <span
                                ...
                                <small class="text-muted" id="passwordMatchText">Re-enter your new password to
                                    confirm.</small>
                            </div>
                            ...
                            <div class="d-flex justify-content-end gap-2 mt-4">
                                @php
                                    ...
                                    } elseif (auth()->user()->isTreasurer() || auth()->user()->isAccountant()) {
