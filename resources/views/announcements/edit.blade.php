                    ...
                    <div class="col-12">
                        ...
                        <div class="card border-light bg-light">
                            <div class="card-body">
                                <div class="d-flex gap-4 mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="target_type" id="target_all" value="all" 
                                            {{ old('target_type', $announcement->target_type) == 'all' ? 'checked' : '' }} onchange="toggleTargeting()">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="target_type" id="target_specific" value="specific" 
                                            {{ old('target_type', $announcement->target_type) == 'specific' ? 'checked' : '' }} onchange="toggleTargeting()">
                                ...
                                <div id="specific_members_container" style="display: {{ old('target_type', $announcement->target_type) == 'specific' ? 'block' : 'none' }};">
                                    <div class="mb-2">
                                                ...
                                                <div class="col-md-6 col-lg-4 member-selection-item" data-name="{{ strtolower($member->full_name) }}" data-id="{{ strtolower($member->member_id) }}">
                                                    <div class="form-check border rounded p-2 px-4 h-100">
                                                        <input class="form-check-input" type="checkbox" name="target_member_ids[]" 
                                                            ...
                                                            {{ (is_array(old('target_member_ids')) && in_array($member->id, old('target_member_ids'))) || (isset($targetedMemberIds) && in_array($member->id, $targetedMemberIds)) ? 'checked' : '' }}>
                        ...
                        <div class="card border-info">
                            <div class="card-body">
                                ...
                                <small class="text-muted d-block mt-2">
                                    ...
                                    If checked, an SMS will be sent to the selected target audience when this announcement is updated.
